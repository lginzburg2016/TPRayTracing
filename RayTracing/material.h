...
//on fait le lien entre la classe material et la structure de donnees hit_record
struct hit_record;
...
//gestion de la reflexion des materiaux
vec3 reflect(const vec3& v, const vec3& n) {
	return v - 2 * dot(v, n)*n;
}

//gestion de la refraction, pour les materiaux dielectriques notamment
...
//classe materiau lambertian
//herite de la classe materiau
